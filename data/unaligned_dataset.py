...
import numpy as np
import torch
from data.utils import cvtColor
from data.anchors import get_anchors
class UnalignedDataset(BaseDataset):
    ...
    def __init__(self, opt):
        ...
        self.B_size = len(self.B_paths)  # get the size of dataself.set B
    ...
    def __getitem__(self, index):
        ...
        return {'A': A, 'B': B, 'A_paths': A_path, 'B_paths': B_path, 'C': C}
