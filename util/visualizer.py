...
class Visualizer():
    ...
    def display_current_results(self, visuals, epoch, save_result, total_iters, update_html_freq):
        ...
        if self.use_html and (save_result or not self.saved):  # save images to an HTML file if they haven't been saved.
            ...
            for label, image in visuals.items():
                image_numpy = util.tensor2im(image)
                img_path = os.path.join(self.img_dir, 'epoch%.3d_%s_%.3d.png' % (epoch, label,total_iters/update_html_freq))
